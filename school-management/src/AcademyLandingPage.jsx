...
const AcademyLandingPage = () => {
  ...
  return (
    <div className="academy-landing">
      {/* Navigation */}
      <nav
        className={`navbar-modern ${isMobileMenuOpen ? "mobile-active" : ""}`}
      >
        <div className="nav-container">
          ...
          <ul className="nav-links-modern">
            ...
            <li>
              <Link to="/campus" onClick={() => setIsMobileMenuOpen(false)}>
                Sanctuary
              </Link>
            </li>
            <li>
          ...
          <div className="nav-actions-modern">
            <Link to="/signin" className="portal-link">
              Portal
            </Link>
            <button
        ...
        <section className="hero-modern">
          ...
          <div className="hero-content-modern">
            ...
            <p className="hero-subtitle-modern animate-slide-up delay-1">
              Welcome to GEOZIIE INTERNATIONAL SCHOOL, a sanctuary of radical
              innovation and classical wisdom. Where we don't just teach the
              future—we build it.
            </p>
            <div className="hero-buttons-modern animate-slide-up delay-2">
              <button className="primary-cta" onClick={openModal}>
                Start Your Application
              </button>
              <Link to="/home" className="secondary-cta">
                Explore the Campus
              </Link>
            </div>
          </div>
            ...
            <div className="vision-grid-modern">
              <div className="vision-text-modern">
                ...
                <p className="vision-paragraph-modern">
                  GEOZIIE INTERNATIONAL SCHOOL is more than an institution; it's
                  a meticulously designed ecosystem for intellectual and
                  creative expansion. We blend centuries of pedagogical wisdom
                  with cutting-edge environmental psychology and cognitive
                  science.
                </p>
                <div className="vision-features-modern">
                  <div className="v-feature">
                    ...
                    <div>
                      ...
                      <p>
                        Curriculums that evolve with your unique cognitive
                        profile.
                      </p>
                    </div>
                  </div>
                  <div className="v-feature">
                    ...
                    <div>
                      ...
                      <p>
                        Connect with industry titans and visionary researchers
                        globally.
                      </p>
                    </div>
                  </div>
            ...
            <div className="calendar-main">
              <div className="event-stack-modern">
                {filteredEvents.map((event) => (
                  <div
                    key={event.id}
                    className="event-card-modern glass-card-modern"
                  >
          ...
          <div className="faculty-container">
            <div className="faculty-header">
              ...
              <p className="faculty-subtitle">
                Our mentors are world-renowned researchers and creators.
              </p>
            </div>
        ...
        <section className="cta-banner-modern">
          <div className="cta-card-modern">
            ...
            <p className="cta-text-modern">
              Secure your place in the next academic cycle. Limited slots
              available for the Innovation Cohort.
            </p>
        ...
        <div className="footer-container-modern">
          <div className="footer-top">
            <div className="footer-brand-modern">
              <span className="logo-text">GEOZIIE INTERNATIONAL SCHOOL</span>
              <p>
                A Century of Excellence, Re-engineered for the Digital Frontier.
              </p>
            </div>
          ...
          <div className="footer-bottom-modern">
            <p>© 2026 GEOZIIE INTERNATIONAL SCHOOL. All Rights Reserved.</p>
      ...
      {isModalOpen && (
        <div className="modal-overlay-modern" onClick={closeModal}>
          <div
            className="modal-card-modern glass-card-modern"
          ...
          >
            ...
            <div className="modal-header-modern">
              ...
              <p>
                Please provide your academic details for a personalized
                evaluation.
              </p>
            </div>
