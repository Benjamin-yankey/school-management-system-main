...
export default function Sidebar({ active, onNavigate, isOpen, onClose }) {
  return (
    ...
    >
      ...
      <div style={{
        fontSize: 11, fontWeight: 700, color: T.text3, letterSpacing: 1.5,
        textTransform: "uppercase", padding: "0 12px 16px", opacity: 0.8
      }}>
        Navigation
      </div>
      ...
      <div style={{
        ...
        lineHeight: 1.8, opacity: 0.6, letterSpacing: 0.5
      }}>
        <div style={{ fontWeight: 800, color: T.text1, opacity: 0.9 }}>SchoolSync</div>
        Teacher Portal v2.0
      </div>
    </aside>
  );
