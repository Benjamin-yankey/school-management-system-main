...
const Home = () => {
  ...
  const stats = [
    {
      ...
      description:
        "Securing positions within Fortune 500 companies and elite research labs within 6 months.",
    },
    {
      value: "Top 1",
      suffix: "%",
      ...
      description:
        "Globally recognized contributions to Artificial Intelligence, Bio-Engineering, and FinTech.",
    },
    {
      value: "50",
      suffix: "+",
      ...
      description:
        "Collaborative academic ventures with Ivy League and leading technological institutes.",
    },
  ];
  ...
  const galleryItems = [
    {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDSYA_9sHZey0gDZ1pwIzP8CCrWurKkz5uA0M2KqB-R_eCdFmG4oWa6iszC9loatt0I3V67RnQWxTeOS_MzQYx15Td9Wh2-AOiTgT9zQksPV0penjQoLUitNE7S15euPJzj-F-JdeyX1K0ojK8VSk1XyFuBKltMJGLoYfwh9wgpzw-cb7KxvGYSHpujNlTlcaYTrMAa-MpWDEvYpCFjFrw7cqya5VnQf8g1GOtTiGrUI9uofP1rYQ3-sBk_IV5r3j-O8VNLnO_2cuUn",
    },
    {
      title: "Rooftop Libraries",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuACSzuFHnTguXDCIp70SzHgIEFHEo1UzytA8X6bbRrKH5Ey7KyAFZkddiVQ48P4_4gMwWG6f7mQfB1sTxqmZn_4zl7C89qBwb8Bw5uV7l5N4PSlr1zw1f8AsTrXPzlfjeygK3dMVcQdHhBISfQDZSgojl_naILx_haB2fGNjFi1jBkS5-f5PHOhGvbeCKPkGZZd5TuT0-TmaikvpIn-9XPtqgxGXZ9RQSoDke-sYOQZ0tp4OyocCEAoZRu-4YnjpwxeT0exBwfxZsCX",
    },
    {
      title: "Creative Studios",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuB4lVNQyIe80GjGtne6uU1dAU3pDsFasFSJiprZaSR4YFkMXlISVPk0qw8GzF3t8lI3Bjmn88_lBzbNFOy88Im6LTJPH5t2x9oeCn30irG9jOoANp8odToZv3lY8IPlNcIHreUZtR9-jTMeLUz1_9_KKEYHu7FYRJrbhDQzKRAHt_s8QndbO16Bj73KkXjf1SHWY1D5WtwX5VwTO5k-xVqInbnVcPb_NOeZaF2f3iHxDCuxIxp6Mp1kKN2mGLqczO8Tl01V-cvHCtT1",
    },
    {
      title: "Collaboration Zones",
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuDHGAPYDx_2R8yALjbiA-GexxRVhGp0MY_oavvUaqA5HAnqz8ux7HsbBG9fJ6NpEyMVwjMuKdh71qnmhB3uiaANV-fhKNoKKBY6MMr-mEhzD57Yqq7RUAHgFGeSPerdKHnoqe7ajizxbVIveho9BsygsODuNGrzrj3F8tznERDw5C4PBeoahBp51Emkvd5cKiX8Vf63Pf7rMWQG2dtYnjGZGM7DoaAEuy_xCfoBl8P-Slj7iGjsjfkbJMvmECQzGEun8Q3QMqVDOihX",
    },
  ];
  ...
  const allEvents = [
    ...
    },
    {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuC_1VvHdfDc8gx5tNuNLoD21bi0DHMIAV3cB_ilbAVDmqEXAA7Rv1KsPrOJ5nlnvLR69MJwIShY0b0c4lBSkMzB9tMcC1mfAiwOQgzAlGW9JlaH_QQhbbLoxv_JoKz7icy3F-DGHIl0mVRGm7dCdjqt0gvMBoI-bd3iONas5INTESYOOgXscxzjprbMsJMOMkzvNZipIzWZI_W1ECMHUzmHRsqn-8zoGHfh28N1nwJATxgR4LbXhmQvTI6fiXSzzrUjKsQv2Jio0g1J",
    },
  ];
        ...
        <section className="hero-section">
          ...
          <div className="hero-content">
            ...
            <p className="hero-description">
              Step into a sanctuary designed for the next generation of
              thinkers, creators, and innovators. Where tradition meets
              hyper-modernity.
            </p>
          ...
          <div className="mission-container">
            <div className="mission-copy">
              <h2 className="section-title">
                Re-imagining the <br />
                <span className="text-secondary">Scholastic Sanctuary</span>
              </h2>
              <p className="section-text">
                GEOZIIE INTERNATIONAL SCHOOL is more than an institution; it's a
                meticulously designed ecosystem for intellectual and creative
                expansion. We blend centuries of pedagogical wisdom with
                cutting-edge environmental psychology and cognitive science.
              </p>
                ...
                <div className="feature-item">
                  ...
                  <div>
                    ...
                    <p className="feature-description">
                      Quantum-ready facilities for breakthrough research.
                    </p>
                  </div>
                </div>
                <div className="feature-item">
                  ...
                  <div>
                    ...
                    <p className="feature-description">
                      Where digital and physical art forms converge.
                    </p>
                  </div>
                </div>
              </div>
          ...
          <div className="pillars-grid">
            <div className="bento-card bento-card-large glass-card">
              ...
              <p className="bento-card-text">
                Our student body represents 45 nations, creating a rich tapestry
                of perspectives and cultural intelligence.
              </p>
            </div>
            <div className="bento-card bento-card-medium">
              ...
              <div>
                ...
                <p className="bento-card-text">
                  Personalized learning paths powered by state-of-the-art neural
                  engines.
                </p>
              </div>
            </div>
            <div className="bento-card bento-card-wide glass-card">
              ...
              <div className="bento-card-text-wrapper">
                ...
                <p className="bento-card-text">
                  Exploring the frontier of human-machine interaction in our
                  dedicated robotics wing.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="legacy-section">
          <div className="legacy-container">
            ...
            <div className="legacy-content">
              ...
              <p className="section-text">
                What began a century ago as a quiet sanctuary for classical
                scholars has been fundamentally re-engineered for the digital
                frontier. We have preserved the sanctity of deep thought while
                integrating the boundless potential of the metaverse and
          ...
          <div className="gallery-header">
            <div>
              ...
              <p className="section-subtitle">
                A sanctuary for the soul and the mind.
              </p>
            </div>
          ...
          <div className="events-container">
            <div className="events-header">
              <div>
                ...
                <p className="section-subtitle">
                  Curated explorations for the inquisitive mind.
                </p>
              </div>
          ...
          <div className="cta-card glass-card">
            <div className="cta-content">
              ...
              <p className="cta-text">
                Applications for the next academic cycle are now being reviewed.
                Secure your place in the future of education.
              </p>
        ...
        <section className="cta-section">
          ...
          <div className="cta-content">
            ...
            <p className="cta-description">
              The next evolution of academic brilliance starts here. Secure your
              place in the most innovative community on the planet.
            </p>
            <Link
        ...
        <div className="footer-container">
          <div className="footer-brand">
            ...
            <p className="footer-copy">
              A Century of Excellence, Re-engineered.
            </p>
          </div>
